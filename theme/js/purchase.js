      ...
      $.ajax({
          ...
          success: function (r) {
              ...
              for (let n = 0; n < r.length; n++) {
                  data_html += `<option value="${r[n].id}">${r[n].supplier_name} - (${r[n].address})</option>`;
              }
        ...
        if ($('.supplier_list_select option:selected').val() == '') {
          ...
          $.ajax({
              ...
              data: {
                ...
                'who_providevara_cost':   $('input[name="vara_cost_s"]:checked').val(),
                ...
                'pur_comm':               $('.discount_of_this_transport_tks').val(), 
              ...
              success: function (res) {
                ...
                if (res == 0) {
                  ...
                  if ($('.rastay_namce_bosta').val() == '' || $('.rastay_namce_bosta').val() == 0) {
                    ...
                    $('.account_form_assign_sys').html(`<center><a href="sales/add_rasta?trans_id=${res}" class=" btn btn-warning btn-lg " style="font-size: 40px; font-weight: bold; " > রাস্তায় বিক্রি </a></center>`);
                  }
