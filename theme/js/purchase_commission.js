...
function get_sales_full_infos(pur_item_id) {
    ...
    $.ajax({
        ...
        success: function (resp) {
            ...
            for (let a = 0; a < resp.sales_item_info.length; a++) {  
                html_data_sales += `<div class="sscontainer-box">
                                        <div class="row tr_all_input_box" pur_items_unq_auto_iddd="${resp.sales_item_info[a].pur_item_a_priddd}" purchases_idd="${resp.sales_item_info[a].purchase_apr_ids}" pur_trans_auto_iddds="${resp.sales_item_info[a].trans_uniq_primary_id}" items_iiiiid="${resp.sales_item_info[a].item_id}" >
                                            <div class="col-md-2">
                                                <label>মোট বস্তা</label>
                                                <input type="text" class="form-control ttl_bosta_box "  inputmode="numeric"  value="${resp.sales_item_info[a].sales_qnty_bostas}" placeholder="মোট বস্তা">
                                            </div>
                                            <div class="col-md-3">
                                                <label>ওজন:</label>
                                                <input type="text" class="form-control ttl_weight_box_ss " inputmode="numeric"  value="${resp.sales_item_info[a].ttl_sale_kgs_this_product}" placeholder="মোট ওজন">
                                            </div>
                                            <div class="col-md-3">
                                                <label>দাম</label>
                                                <input type="text" class="form-control kg_rate_box_s " inputmode="numeric"  value="${resp.sales_item_info[a].price_per_kg}" placeholder="দাম">
                                            </div>
                                            <div class="col-md-3">
                                                <label>মোট দাম</label>
                                                <input type="text" class="form-control ttl_rates_this_rowss " inputmode="numeric"  value="${resp.sales_item_info[a].total_sales_price_cost_sss}" placeholder="মোট দাম" readonly >
                                            </div>
                                            <div class="col-md-1 text-center">
                                                <br>
                                                <button class="ssdelete-btn"><i class="fa fa-trash"></i></button>
            ...
            $('.append_contain_boxs').append(`<h3 class="text-center" style="margin-top: 0; " > ${resp.pur_item_info.ref_lot_no} </h3> ${html_data_sales}`);
        }
    });
                    ...
                    `<div class="col-md-6">
                        ...
                        <table class="custom-table">
                            ...
                            <tbody class="sale_details_ss">
                                ...
                                <tr class="total-row">
                                    <td colspan="3">মোট: </td>
                                    <td id="final-sale">${formatter.format(ttl_sales_amnt_taka).getDigitBanglaFromEnglish()} টাকা</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
