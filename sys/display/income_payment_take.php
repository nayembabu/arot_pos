        ...
        <div class="col-md-12">
          ...
          <div class="box box-info ">
            ...
            <!-- /.box-header -->
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-control select2 select_customers_id " id="" name=""  style="width: 100%;">
                                ...
                                <?php foreach ($cus_s as $cus) { 
                                  if ($cus->id != 1) { ?>
                                    <option value="<?php echo $cus->id; ?>"><?php echo $cus->customer_name; ?> --- <?php echo $cus->address; ?></option>
                                <?php } } ?>
                            </select>
                        </div>
                    </div>
                ...
                <div class="box-header row customer_info_assign container-fluid "></div>
                <div class="box-header row container-fluid searching_html_datas " style="margin-top: 20px; "></div>
