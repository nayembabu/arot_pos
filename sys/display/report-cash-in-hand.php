    ...
    <div class="center container">
            <div class="card">
               <div class=" box box-primary ">
                  ...
                  <div class="container">
                  <div class="col-md-4 p-3 text-center " style="font-size: 30px;" >আজকের ক্যাশ হচ্ছে</div>
                  </div>
                  <div class="col-md-4"></div>
                  </div>
                  <hr>
                  <div class="row container">
                        ...
                        <div class="card">
                           <div class="box box-primary">
                              <div class="input-group date">
                                 ...
                                 <input type="text" class="form-control pull-right datepicker  searching_date_picks "  id="pur_date" name="pur_date" readonly  value="<?= date('d-m-Y');?>">
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-4 ">
                        <div class="input-group p-3">
                           <div class="btn btn-success  submit_btn_cash_in_h "> সার্চ করুন </div>
                        </div>
                     </div>
                  </div>
                  <br>
                  ...
                  <div class="">
                     <div class="">
                        <div class="box box-success shadow">
                           <div class=" text-center p-3 show_cash_in_hand border " style="font-size: 70px;">
                           <?php echo numfmt_format_currency(numfmt_create( 'en_IN', NumberFormatter::CURRENCY ), $income_count - $expense_count, "") ?>
                           <br><br><br>
                  ...
                  <div class="form-group col-md-4">
                     ...
                     <div class="col-sm-12">
                        <div class="input-group date">
                           ...
                           <input type="text" class="form-control pull-right datepicker  star_date_select "  id="pur_date" name="pur_date" readonly  value="<?= date('d-m-Y');?>">
                        </div>
                  ...
                  <div class="form-group col-md-4">
                     ...
                     <div class="col-sm-12">
                        <div class="input-group date">
                           ...
                           <input type="text" class="form-control pull-right datepicker  end_select_date "  id="pur_date" name="pur_date" readonly  value="<?= date('d-m-Y');?>">
                        </div>
                        <span id="pur_date_msg" style="display:none" class="text-danger"></span>
                     </div>
                  </div>
      ...
      if ($('.searching_date_picks').val() == '') {
         ...
         $.ajax({
            ...
            success: function (rnn) {
               $('.show_cash_in_hand').html((rnn.income_count - rnn.expense_count).toLocaleString('en-IN'));
            }
         });
      }
