              ...
              <div class="box-body">
                ...
                <div class="col-md-5">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control only_currency incomes_amounts " inputmode="numeric" id="expense_amt" name="expense_amt" placeholder="" style="text-align: right; " value="" >
