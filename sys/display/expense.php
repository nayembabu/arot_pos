          ...
          <div class="box box-info ">
            ...
            <form class="form-horizontal" id="expense-form" >
              ...
              <div class="box-body">
                ...
                <div class="col-md-5">
                  ...
                  <div class="col-sm-8">
                    <div class="input-group date">
                      ...
                      <input type="text" class="form-control pull-right datepicker expense_date" value="<?php echo  $expense_date; ?>" id="expense_date" name="expense_date" readonly >
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control only_currency expense_amt" inputmode="numeric" id="expense_amt" name="expense_amt" placeholder="" style="text-align: right; " value=""  >
               ...
               <div class="col-md-5">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control expense_for" id="expense_for" name="expense_for" placeholder=""  value="<?php print $expense_for; ?>" >
             ...
             <div class="box-footer">
                <div class="col-sm-8 col-sm-offset-2 text-center hide_this_saving_now ">
