  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
     <section class="content">
      ...
      <div class="container">
         <div class="row justify-content-center normal_customaer_info" style="display: none;">
            <div class="col-md-4">
                <div class="form-group">
                    <label for="customerName">কাস্টমার নাম:</label>
                    <input type="text" class="form-control normal_cust_namess" id="customerName" placeholder="আপনার নাম লিখুন" >
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label for="customerMobile">কাস্টমার মোবাইল:</label>
                    <input type="text" class="form-control normanl_cust_mobile_no_s" id="customerMobile" placeholder="মোবাইল নাম্বার লিখুন" >
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label for="customerAddress">কাস্টমার ঠিকানা:</label>
                    <textarea class="form-control normal_customer_full_address" id="customerAddress" placeholder="আপনার ঠিকানা লিখুন" rows="1" ></textarea>
                </div>
            </div>
        </div>
      </div>
