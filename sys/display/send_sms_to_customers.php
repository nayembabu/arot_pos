                           ...
                           <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3 col-md-offset-3">
                                        <button type="button" id="view" class=" btn btn-block btn-success search_sale_report " title="Save Data">Show</button>
                                    </div>
                                </div>
                            </div>                              
                        </form>
                  ...
                  <div class="col-md-12">
                     <div class="box">
                        <div class="box-header">
                           <h2 class="box-title " style="position: absolute; font-size: 24px;; top: 50%; left: 50%; transform: translate(-50%, -50%);"><span class="date_assgn" ></span> তারিখের বিক্রয় তালিকা</h2>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body table-responsive no-padding">
                           <table class="table table-bordered table-hover " id="report-data" >
                              ...
                              <tbody id="tbodyid" class="sales_datas_assgn_htmls"></tbody>
                           </table>
                        </div>
                        <!-- /.box-body -->
                     </div>
