        ...
        <label for="from_date" class="col-sm-2 control-label"><?= $this->lang->line('from_date'); ?></label>
          ...
          <label for="to_date" class="col-sm-2 control-label"><?= $this->lang->line('to_date'); ?></label>
            ...
            <span id="Sales_date_msg" style="display:none" class="text-danger"></span>
                ...
                <div class="form-group">
                  <label for="item_id" class="col-sm-2 control-label"> কাস্টমার </label>
              ...
              <div class="box-footer">
                  <div class="col-sm-8 col-sm-offset-2 text-center">
                      <div class="col-md-3 col-md-offset-3">
                          <button type="button" id="view" class="btn btn-lg my-custom-btn cust_serching_btn_this_reports  custom-search-btn" title="খুজুন">
        ...
        <div class="col-md-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <h2 class="box-title cust_name " style="font-weight: bold; font-size: 22px; " >কাস্টমারের নাম </h2><br>
              <h2 class="box-title cust_mobile " style="font-weight: bold; font-size: 16px; " >কাস্টমারের মোবাইল নং </h2><br>
              <h2 class="box-title cust_address "  >কাস্টমারের ঠিকানা </h2>
            </div>
            <!-- /.box-header --> 
...
<script src="<?php echo $theme_link; ?>js/report_sell_full_commission_history.js"></script> 
