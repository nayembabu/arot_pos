          ...
          <div class="box box-info "><br>
            ...
            <div class="box-body table-responsive no-padding">
                ...
                <div class="form-group col-md-8">
                    <label for="to_date">মহাজন সিলেক্ট করুন</label> 
                    <select class="form-control supplier_selected_id select2 "  >
                        <option value="">মহাজন লিস্ট</option>
                        <?php foreach($suppliers as $supplier) { ?>
                            <option value="<?php echo $supplier->id; ?>"> <?php echo $supplier->supplier_name; ?> ---  <?php echo $supplier->address; ?> </option>
                        <?php } ?>
                    </select>
                </div>
