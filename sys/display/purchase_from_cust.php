...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="supplier_id" class="col-sm-2 control-label"> কাস্টমারের নাম <label class="text-danger">*</label></label>
                                            <div class="col-sm-3">
                                                <div class="input-group">
                                                    <select class="form-control select2 supplier_list_select " id="supplier_id" name="supplier_id"  style="width: 100%;">
                                                    </select> 
                                                    <span class="input-group-addon pointer" title="New Supplier?"></span>
                                                </div>
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            <label for="purchase_status" class="col-sm-2 control-label" style="display: none; "><?= $this->lang->line('status'); ?> <label class="text-danger">*</label></label>
        ...
        <!-- ./wrapper -->
        <script src="<?php echo $theme_link; ?>js/purchase_customer.js"></script>
