      ...
      <div class="row">
            ...
            <form class="form-horizontal" id="customers-form" >
              ...
              <div class="box-body">
                ...
                <div class="col-md-5">
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control cus_name" id="customer_name" name="customer_name" placeholder=""  value="<?php print $customer_name; ?>" >
               ...
               <div class="col-md-5"> 
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control no_special_char_no_space cus_mobile_no" id="mobile" name="mobile" inputmode="numeric" placeholder="" value=""  >
               ...
               <div class="col-md-5"> 
                  ...
                  <div class="form-group">
                    <label for="mobile" class="col-sm-4 control-label">সাবেক হিসাব</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control no_special_char_no_space cus_previous_due" id="due" name="due" inputmode="numeric" placeholder="" value=""  >
                      <span id="mobile_msg" style="display:none" class="text-danger"></span>
                    </div>
                  </div>
              ...
              <div class="col-md-12" > 
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea type="text" class="form-control cus_addrs" id="address" name="address" placeholder="" ><?php print $address; ?></textarea>
              ...
              <div class="box-footer saving_btn_sho_hide ">
                              <div class="col-sm-8 col-sm-offset-2 text-center">
                                 <!-- <div class="col-sm-4"></div> -->
                                 <div class="col-md-3 col-md-offset-3 saving_btn_sho_hide">
        ...
        <div class="box-body">
              <table id="example2" class="table table-bordered table-striped" width="100%">
                ...
                <tbody class="assign_customer_data">
