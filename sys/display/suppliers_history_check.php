              ...
              <div class="box-footer">
                <div class="col-sm-8 col-sm-offset-2 text-center">
                   <div class="col-md-3 col-md-offset-3">
                      <button type="button" id="view" class=" btn btn-block btn-success supp_serching_btn_this " title="Save Data">Show</button>
                   </div>
                   <div class="col-sm-3">
...
<script src="<?php echo $theme_link; ?>js/report_supplier_history_check.js"></script>
