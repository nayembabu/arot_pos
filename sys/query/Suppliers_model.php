...
class Suppliers_model extends CI_Model {
	...
	var $column_order = array('a.supplier_code','a.id', 'a.address','a.supplier_name','a.mobile','a.email','a.opening_balance','a.purchase_due','a.purchase_return_due','a.status'); //set column field database for datatable orderable
	var $column_search = array('a.supplier_code','a.id', 'a.address','a.supplier_name','a.mobile','a.email','a.opening_balance','a.purchase_due','a.purchase_return_due','a.status'); //set column field database for datatable searchable 
