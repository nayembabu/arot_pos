...
class Customers_model extends CI_Model {
	...
	var $column_order = array('a.customer_code','a.address','a.id','a.customer_name','a.mobile','a.email','a.status','a.sales_due','a.sales_return_due'); //set column field database for datatable orderable
	var $column_search = array('a.customer_code','a.address','a.id','a.customer_name','a.mobile','a.email','a.status','a.sales_due','a.sales_return_due'); //set column field database for datatable searchable 
	...
	public function getCustomersArray($id=''){
		...
		$this->db->select("id, customer_name, address, mobile")->from('db_customers');
